...
from fasthtml.common import FastHTML, serve, Div, H1, H2, H3, H4, P, A, Title
...
def home():
    return Container(
        ...
        Row(
            Col(
                Card("I lift up when hovered!", header="Hover Lift", cls=[Fx.base, Fx.hover_lift, "cursor-pointer h-100"]),
                xs=12, sm=6, lg=3
            ),
            Col(
                Card("I get bigger when hovered!", header="Hover Scale", cls=[Fx.base, Fx.hover_scale, "cursor-pointer h-100"]),
                xs=12, sm=6, lg=3
            ),
            Col(
                Card("I 3D tilt when hovered!", header="Hover Tilt", cls=[Fx.base, Fx.hover_tilt, "cursor-pointer h-100"]),
                xs=12, sm=6, lg=3
            ),
            Col(
                Card("I glow with the primary color!", header="Hover Glow", cls=[Fx.base, Fx.hover_glow, "cursor-pointer h-100"]),
                xs=12, sm=6, lg=3
            ),
            Col(
                Card("I start gray and get color!", header="Hover Colorize", cls=[Fx.base, Fx.hover_colorize, "bg-success text-white cursor-pointer h-100"]),
                xs=12, sm=6, lg=3
            ),
            cls="g-3 mb-5"
        ),
        ...
        Row(
            Col(
                Card(
                    Div(cls=f"rounded bg-secondary {Fx.shimmer}", style="height: 100px; opacity: 0.1"),
            ...
            Col(
                Card(
                    Div(Icon("heart-fill", size=2, cls="text-danger"), cls=f"text-center py-4 {Fx.pulse}"),
                    header="Pulse Effect",
                    cls="h-100"
                ),
                xs=12, sm=6, lg=4
            ...
            Col(
                Card(
                    Div(Icon("arrow-repeat", size=2, cls="text-primary"), cls=f"text-center py-4 {Fx.spin}"),
                    header="Spin Effect",
                    cls="h-100"
                ),
                xs=12, sm=6, lg=4
